...
public interface CommentMapper {
    ...
    public String INSERT_COMMENT = "INSERT INTO T3_COMMENT VALUES(#{c_no},#{c_writer},#{c_writer_email},#{c_content},#{c_date})";
    public String SELECT_PAGE_BY_PAGENO = "SELECT * FROM t3_detailpage WHERE d_pageno=#{pageno}";
    public String GET_COMMENTS = "select c.c_no, c.c_writer, c.c_writer_email, c.c_content, c.c_date FROM(" + 
    		"select a.d_pageno, a.c_no, b.c_writer, b.c_writer_email, b.c_content, b.c_date " + 
    		"from t3_detailpage_comment a, t3_comment b " + 
    		"where a.c_no=b.c_no " + 
    		") c " + 
    		"where c.d_pageno = #{d_pageno}";
